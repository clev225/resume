<?php
    ...
    $totalUsersQuery2 = "SELECT COUNT(*) AS totalresumes FROM resumes";
    $totalUsersResult2 = $db->query($totalUsersQuery2);
    $totalResumes = $totalUsersResult2->fetch_assoc()['totalresumes'];
?>
                                ...
                                <div class="row g-0 w-100">
                                    <div class="col-6">
                                        <div class="p-3 m-1">
                                            ...
                                            <p class="mb-0" style="color:black;"><?php echo $totalResumes;?> Profiles</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-0 d-flex flex-fill">
                                <div class="row g-0 w-100">
                                    <div class="col-6">
                                        <div class="p-3 m-1">
                                            <h4>Total Users</h4>
                                            <p class="mb-0" style="color: black;"><?php echo $totalUsers; ?> Users</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
