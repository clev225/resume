  ...
  <div class="container marketing">
    ...
    <div class="row featurette" style="margin-top: 30px;">
      ...
      <div class="col-md-5">
        <!-- <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 500x500"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#aaa" dy=".3em">500x500</text></svg> -->
         <img src="./assets/images/lndng.png" alt="landing">
      </div>
    ...
    <div class="row featurette" id="more-info">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading" style="font-weight: bold;">Welcome to eProfile!</h2>
        <p class="lead">At eProfile, we understand that crafting a compelling resume is essential for career success. Whether you’re a seasoned professional or just starting out, our website is here to help you stand out from the crowd.</p>
      </div>
