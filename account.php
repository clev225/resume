<?php
    $title = "Account | eProfile Personal Profile Generator";
        ...
        <div>
            ...
            <form action="actions/updateprofile.action.php" method="post" class="row g-3 p-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="full_name" placeholder="Full Name" value="<?=@$user['full_name']?>" class="form-control" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Email</label>
                    <input type="email" name="email_id" placeholder="Email Address" value="<?=@$user['email_id']?>" class="form-control" required>
                </div>
                <div class="col-12">
